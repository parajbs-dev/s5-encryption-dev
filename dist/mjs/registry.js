...
import { DEFAULT_GET_ENTRY_OPTIONS, DEFAULT_SET_ENTRY_OPTIONS, } from "./defaults";
import { convertS5CidToB3hashHex, encodeBase64URL, decodeBase64URL, makeUrl, addUrlQuery, recordTypeRegistryEntry, registryS5CIDByte, cidTypeResolver, mhashBlake3Default, mkeyEd25519, } from "s5-utils-js";
import { KeyPairEd25519, CryptoImplementation, encodeEndianN, equalBytes, encodeCid, } from "s5-crypto-utils";
/**
 ...
 */
export async function getEntry(publicKey, customOptions) {
 ...
 */
export async function getEntryUrl(publicKey, customOptions) {
    const opts = { ...DEFAULT_GET_ENTRY_OPTIONS, ...this.customOptions, ...customOptions };
 ...
 */
export function getEntryUrlForPortal(portalUrl, publicKey, customOptions) {
 ...
 */
export async function setEntry(sre, customOptions) {
 ...
 */
export async function signEntry({ privateKey, data, revision, }) {
 ...
 */
export async function createSignedEntry(privateKey, entryData) {
    const kp = new KeyPairEd25519(decodeBase64URL(privateKey));
 ...
 */
export async function resolverEntry(cid) {
 ...
 */
export async function createResolverEntry(privateKey, cid) {
