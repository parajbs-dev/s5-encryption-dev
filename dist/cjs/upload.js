...
const s5_encrypt_wasm_1 = require("s5-encrypt-wasm");
/**
...
async function uploadSmallFileRequest(file, customOptions) {
    ...
    if (opts.encrypt) {
        ...
        await (0, s5_encrypt_wasm_1.__wbg_init)();
        const encryptedKey = (0, s5_encrypt_wasm_1.generate_key)();
        // eslint-disable-next-line
        let { encryptedFile, encryptedCid } = await (0, s5_encrypt_wasm_1.encryptFile)(file, file.name, encryptedKey, cid);
        ...
        response.data["cidWithoutKey"] = (0, s5_encrypt_wasm_1.removeKeyFromEncryptedCid)(encryptedCid);
    }
    else {
...
async function uploadLargeFileRequest(file, customOptions) {
    ...
    if (opts.encrypt) {
        // Initialize the WASM module
        await (0, s5_encrypt_wasm_1.__wbg_init)();
        encryptedKey = (0, s5_encrypt_wasm_1.generate_key)();
        const { b3hash: b3hashEncrypt, encryptedFileSize } = await (0, s5_encrypt_wasm_1.calculateB3hashFromFileEncrypt)(file, encryptedKey);
        ...
        const padding = 0;
        const encryptedCidBytes = (0, s5_encrypt_wasm_1.createEncryptedCid)(s5_utils_js_1.cidTypeEncrypted, s5_utils_js_1.encryptionAlgorithmXChaCha20Poly1305, s5_encrypt_wasm_1.chunkSizeAsPowerOf2, encryptedBlobHash, encryptedKey, padding, cid);
    ...
    return new Promise((resolve, reject) => {
        const tusOpts = {
            ...
            onSuccess: async () => {
                ...
                if (opts.encrypt)
                    ...
                    resCid = uCid;
                const encryptedCidWithoutKey = opts.encrypt ? (0, s5_encrypt_wasm_1.removeKeyFromEncryptedCid)(encryptedCid) : "";
        ...
        const reader = (0, s5_encrypt_wasm_1.getEncryptedStreamReader)(file, encryptedKey);
        let upload;
        if (opts.encrypt)
